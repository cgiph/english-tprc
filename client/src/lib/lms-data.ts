...
<div class="space-y-12">
  <div class="bg-slate-900 text-white p-6 rounded-xl border-l-4 border-indigo-500">
    <h2 class="text-2xl font-bold mb-2">Section 2: Reading Test</h2>
    <p class="text-slate-300">Time Allowed: <strong>13-18 Minutes</strong></p>
    <p class="text-sm text-slate-400 mt-2 italic">Note: In the actual exam, each section is timed individually. Manage your time wisely.</p>
  </div>

  <!-- Q1: Fill in the Blanks (R&W) -->
  <div class="space-y-4">
    <div class="flex items-center justify-between">
       <h4 class="font-bold text-indigo-900">Question 1: Fill in the Blanks (Reading & Writing)</h4>
       <span class="text-xs bg-slate-100 px-2 py-1 rounded border">Est. Time: 2 min</span>
    </div>
    <div class="bg-white p-6 rounded-lg border border-slate-300 leading-8 text-lg">
       ...
       <select class="mx-1 border-b-2 border-indigo-500 bg-indigo-50 px-2 py-1 rounded text-sm font-bold text-indigo-900 focus:outline-none">
          ...
          <option>punitive</option>
       </select> 
       to address these nuances, leaving victims with little recourse.
    </div>
  </div>

  <!-- Q2: Fill in the Blanks (R&W) -->
  <div class="space-y-4">
    <div class="flex items-center justify-between">
       <h4 class="font-bold text-indigo-900">Question 2: Fill in the Blanks (Reading & Writing)</h4>
       <span class="text-xs bg-slate-100 px-2 py-1 rounded border">Est. Time: 2 min</span>
    </div>
    <div class="bg-white p-6 rounded-lg border border-slate-300 leading-8 text-lg">
       ...
       means that lifestyle choices may have heritable consequences for future generations.
    </div>
  </div>
  ...
  <div class="space-y-4">
    <div class="flex items-center justify-between">
       <h4 class="font-bold text-indigo-900">Question 3: Multiple Choice (Multiple Answers)</h4>
       <span class="text-xs bg-slate-100 px-2 py-1 rounded border">Est. Time: 2 min</span>
    </div>
    <div class="bg-slate-50 p-4 rounded border border-slate-200 mb-2">
       <p class="font-serif">"The urbanization of the late 19th century was driven not only by industrialization but also by agricultural mechanization, which reduced the need for rural labor. Consequently, cities became melting pots of culture, though they often suffered from poor sanitation and overcrowding."</p>
    </div>
    <p class="font-bold text-sm">Which factors contributed to 19th-century urbanization according to the text?</p>
    <div class="space-y-2">
       <label class="flex items-center gap-3 p-3 border rounded hover:bg-slate-50 cursor-pointer">
          ...
          <span>Industrial growth attracting workers</span>
       </label>
       <label class="flex items-center gap-3 p-3 border rounded hover:bg-slate-50 cursor-pointer">
          <input type="checkbox" class="w-4 h-4 text-indigo-600">
          <span>Improved sanitation in cities</span>
       </label>
       <label class="flex items-center gap-3 p-3 border rounded hover:bg-slate-50 cursor-pointer">
          <input type="checkbox" class="w-4 h-4 text-indigo-600">
          <span>Reduced demand for farm workers due to machines</span>
       </label>
       <label class="flex items-center gap-3 p-3 border rounded hover:bg-slate-50 cursor-pointer">
          <input type="checkbox" class="w-4 h-4 text-indigo-600">
          <span>Government mandates moving people to cities</span>
       </label>
    </div>
  </div>

   <!-- Q4: Reorder Paragraphs -->
   <div class="space-y-4">
      <div class="flex items-center justify-between">
         <h4 class="font-bold text-indigo-900">Question 4: Reorder Paragraphs</h4>
         <span class="text-xs bg-slate-100 px-2 py-1 rounded border">Est. Time: 2-3 min</span>
      </div>
      <div class="grid grid-cols-1 gap-2 text-sm">
         <div class="bg-white p-3 border border-slate-300 rounded shadow-sm cursor-move">
            <span class="font-bold text-indigo-500 mr-2">[ A ]</span>
            However, this initial optimism was soon tempered by the realization of the complexity of natural language.
         </div>
         <div class="bg-white p-3 border border-slate-300 rounded shadow-sm cursor-move">
            <span class="font-bold text-indigo-500 mr-2">[ B ]</span>
            Early AI researchers believed that machine translation would be solved within a few years.
         </div>
         <div class="bg-white p-3 border border-slate-300 rounded shadow-sm cursor-move">
            <span class="font-bold text-indigo-500 mr-2">[ C ]</span>
            Consequently, the field shifted focus towards statistical models rather than rule-based systems.
         </div>
         <div class="bg-white p-3 border border-slate-300 rounded shadow-sm cursor-move">
            <span class="font-bold text-indigo-500 mr-2">[ D ]</span>
            The ambiguity of context and idiom proved to be an insurmountable hurdle for simple algorithms.
         </div>
      </div>
      <div class="text-xs text-slate-400 italic text-right">Target Order: B -> A -> D -> C</div>
   </div>

   <!-- Q5: Reorder Paragraphs -->
   <div class="space-y-4">
      <div class="flex items-center justify-between">
         <h4 class="font-bold text-indigo-900">Question 5: Reorder Paragraphs</h4>
         <span class="text-xs bg-slate-100 px-2 py-1 rounded border">Est. Time: 2-3 min</span>
      </div>
      <div class="grid grid-cols-1 gap-2 text-sm">
         <div class="bg-white p-3 border border-slate-300 rounded shadow-sm cursor-move">
            <span class="font-bold text-indigo-500 mr-2">[ A ]</span>
            These micro-transactions, while individually small, cumulatively represent a massive shift in economic behavior.
         </div>
         <div class="bg-white p-3 border border-slate-300 rounded shadow-sm cursor-move">
            <span class="font-bold text-indigo-500 mr-2">[ B ]</span>
            The digital economy has facilitated the rise of the 'gig worker', allowing for fragmented employment.
         </div>
         <div class="bg-white p-3 border border-slate-300 rounded shadow-sm cursor-move">
            <span class="font-bold text-indigo-500 mr-2">[ C ]</span>
            Regulatory bodies are now struggling to classify these workers under traditional labor laws.
         </div>
         <div class="bg-white p-3 border border-slate-300 rounded shadow-sm cursor-move">
            <span class="font-bold text-indigo-500 mr-2">[ D ]</span>
            Platforms connect freelancers with short-term tasks in real-time.
         </div>
      </div>
      <div class="text-xs text-slate-400 italic text-right">Target Order: B -> D -> A -> C</div>
   </div>

   <!-- Q6: Fill in the Blanks (Drag & Drop) -->
   <div class="space-y-4">
      <div class="flex items-center justify-between">
         <h4 class="font-bold text-indigo-900">Question 6: Fill in the Blanks (Reading)</h4>
         <span class="text-xs bg-slate-100 px-2 py-1 rounded border">Est. Time: 2 min</span>
      </div>
      <div class="bg-white p-6 rounded-lg border border-slate-300 leading-8 text-lg">
         The concept of 'dark matter' was introduced to explain the 
         <span class="border-b-2 border-indigo-300 bg-slate-50 px-3 py-1 min-w-[100px] inline-block"></span> 
         rotational speeds of galaxies. Without this invisible mass, galaxies would 
         <span class="border-b-2 border-indigo-300 bg-slate-50 px-3 py-1 min-w-[100px] inline-block"></span> 
         apart due to lack of gravitational pull.
      </div>
      <div class="bg-slate-100 p-4 rounded border border-slate-200 flex flex-wrap gap-2">
         <span class="bg-white px-3 py-1 rounded border shadow-sm cursor-grab">anomalous</span>
         <span class="bg-white px-3 py-1 rounded border shadow-sm cursor-grab">fly</span>
         <span class="bg-white px-3 py-1 rounded border shadow-sm cursor-grab">stabilize</span>
         <span class="bg-white px-3 py-1 rounded border shadow-sm cursor-grab">predictable</span>
         <span class="bg-white px-3 py-1 rounded border shadow-sm cursor-grab">drift</span>
      </div>
   </div>

   <!-- Q7: Fill in the Blanks (Drag & Drop) -->
   <div class="space-y-4">
      <div class="flex items-center justify-between">
         <h4 class="font-bold text-indigo-900">Question 7: Fill in the Blanks (Reading)</h4>
         <span class="text-xs bg-slate-100 px-2 py-1 rounded border">Est. Time: 2 min</span>
      </div>
      <div class="bg-white p-6 rounded-lg border border-slate-300 leading-8 text-lg">
         Cognitive dissonance occurs when an individual holds two 
         <span class="border-b-2 border-indigo-300 bg-slate-50 px-3 py-1 min-w-[100px] inline-block"></span> 
         beliefs simultaneously. To resolve this psychological discomfort, the mind often 
         <span class="border-b-2 border-indigo-300 bg-slate-50 px-3 py-1 min-w-[100px] inline-block"></span> 
         one of the beliefs to restore consistency.
      </div>
      <div class="bg-slate-100 p-4 rounded border border-slate-200 flex flex-wrap gap-2">
         <span class="bg-white px-3 py-1 rounded border shadow-sm cursor-grab">conflicting</span>
         <span class="bg-white px-3 py-1 rounded border shadow-sm cursor-grab">harmonious</span>
         <span class="bg-white px-3 py-1 rounded border shadow-sm cursor-grab">rationalizes</span>
         <span class="bg-white px-3 py-1 rounded border shadow-sm cursor-grab">amplifies</span>
         <span class="bg-white px-3 py-1 rounded border shadow-sm cursor-grab">ignores</span>
      </div>
   </div>
   ...
   <div class="space-y-4">
    <div class="flex items-center justify-between">
       <h4 class="font-bold text-indigo-900">Question 8: Multiple Choice (Single Answer)</h4>
       <span class="text-xs bg-slate-100 px-2 py-1 rounded border">Est. Time: 1 min</span>
    </div>
    <div class="bg-slate-50 p-4 rounded border border-slate-200 mb-2">
       <p class="font-serif">"While correlation suggests a relationship between two variables, it does not imply causation. A common fallacy is 'post hoc ergo propter hoc'—assuming that because event Y followed event X, event Y must have been caused by event X."</p>
    </div>
    <p class="font-bold text-sm">What is the main warning in the text?</p>
    <div class="space-y-2">
       <label class="flex items-center gap-3 p-3 border rounded hover:bg-slate-50 cursor-pointer">
          <input type="radio" name="mcsa1" class="w-4 h-4 text-indigo-600">
          <span>Events that happen together always have a cause-and-effect link.</span>
       </label>
       <label class="flex items-center gap-3 p-3 border rounded hover:bg-slate-50 cursor-pointer">
          <input type="radio" name="mcsa1" class="w-4 h-4 text-indigo-600">
          <span>Temporal sequence does not prove causality.</span>
       </label>
       <label class="flex items-center gap-3 p-3 border rounded hover:bg-slate-50 cursor-pointer">
          <input type="radio" name="mcsa1" class="w-4 h-4 text-indigo-600">
          <span>Variables are rarely related to each other.</span>
       </label>
    </div>
  </div>
